      ...
      <div class="container">
         ...
         ?>
           <?php 
            for ($i = 0; $i < $size; $i++) {
              ...
              $ID = $arr["PackageID"];
              $PackageName = $arr["PackageName"];
              $Description= $arr["Description"];
              $Duration= $arr["Duration"];
              $Price= $arr["Price"];
              $Car= $arr["CarName"];
              $Image = $arr['PackagePhoto1'];
        ...
        echo  '<div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">';
            ...
            echo  '<div class="text-center mb-3">';
                echo "
                <img src='$FileImage' class='img-thumbnail' alt=''>
              </div>";
           echo  "<h3>$PackageName</h3>
             ...
             <p>Vehicle: $Car</p>
              <p>Price: $Price $</p>
             <p>$Description.</p>
             <p>$Quantity packages left.</p>";
             echo "<a href='package-detail.php?PackageID=$ID' class='readmore stretched-link'>Detail<i class='bi bi-arrow-right'></i></a>
            </div>
